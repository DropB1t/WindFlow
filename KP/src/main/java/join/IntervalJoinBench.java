...
public class IntervalJoinBench {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int lower_bound = argsTool.getInt("lower", 0);
        int upper_bound = argsTool.getInt("upper", 0);
        ...
        orangeSource = new FileSource(runtime, rate, ldataset);
        greenSource = new FileSource(runtime, rate, rdataset);

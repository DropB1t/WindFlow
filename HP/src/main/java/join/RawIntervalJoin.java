...
public class RawIntervalJoin extends AbstractStreamOperator<Tuple3<Integer, Integer, Long>>
                             implements OneInputStreamOperator<Tuple6<Integer, Integer, Long, String, Integer, Integer>, Tuple3<Integer, Integer, Long>> {
    ...
    private void processJoinOrange(BufferEntry bt) {
        final Tuple6<Integer, Integer, Long, String, Integer, Integer> t = bt.tuple;
    ...
    // joinEmit method
    private void joinEmit(Tuple6<Integer, Integer, Long, String, Integer, Integer> left,
                          Tuple6<Integer, Integer, Long, String, Integer, Integer> right,
                          long leftTs,
                          long rightTs) {

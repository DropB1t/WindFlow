...
public class IntervalJoinBench {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple5<Integer, Integer, Long, String, Integer>> keyedStream = unionedStream.keyBy(new DataKeySelector());

        TypeInformation<Tuple3<Integer, Integer, Long>> outType = TypeInformation.of(new TypeHint<Tuple3<Integer, Integer, Long>>() {});
    ...
    // DataKeySelector method
    private static class DataKeySelector implements KeySelector<Tuple5<Integer, Integer, Long, String, Integer>, Integer> {
        @Override
        public Integer getKey(Tuple5<Integer, Integer, Long, String, Integer> value) {
            return value.f0;
        }
    }

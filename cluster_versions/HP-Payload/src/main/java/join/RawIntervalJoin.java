...
public class RawIntervalJoin extends AbstractStreamOperator<Tuple3<Integer, Integer, Long>>
                             implements OneInputStreamOperator<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>, Tuple3<Integer, Integer, Long>> {
    ...
    @Override
    public void processElement(StreamRecord<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> element) {
        final Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]> tuple = element.getValue();
    ...
    private void processJoinOrange(BufferEntry bt) {
        final Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]> t = bt.tuple;
    ...
    // joinEmit method
    private void joinEmit(Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]> left,
                          Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]> right,
                          long leftTs,
                          long rightTs) {

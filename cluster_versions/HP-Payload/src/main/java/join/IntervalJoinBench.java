...
public class IntervalJoinBench {
    ...
    static void topologyModeStandard(RichParallelSourceFunction<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> orangeSource, 
    						  RichParallelSourceFunction<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> greenSource,
    						  Map<Integer, List<Integer>> keyToJoiners) {
        LOG.info("Executing topology with standard Flink");
        // creation of the data-flow graph
        DataStream<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> orangeStream = env.addSource(orangeSource)
                                                    .setParallelism(source1_deg)
                                                    .assignTimestampsAndWatermarks(IngestionTimeWatermarkStrategy.create());

        DataStream<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> greenStream = env.addSource(greenSource)
                                                    .setParallelism(source2_deg)
                                                    .assignTimestampsAndWatermarks(IngestionTimeWatermarkStrategy.create());

        DataStream<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> unionedStream = orangeStream.union(greenStream);

        DataStream<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> multicastStream = unionedStream.partitionCustom(
        ...
        TypeInformation<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> outType1 = TypeInformation.of(new TypeHint<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>>() {});

        DataStream<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> sortedStream =
    ...
    static void topologyModeCustom(RichParallelSourceFunction<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> orangeSource, 
    						RichParallelSourceFunction<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> greenSource,
    					    Map<Integer, List<Integer>> keyToJoiners) {
        ...
        DataStream<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> multicastStream = unionedStream.broadcast(keyToJoiners);
    ...
    public static void main(String[] args) throws Exception {
		...
		RichParallelSourceFunction<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> orangeSource;
    	RichParallelSourceFunction<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> greenSource;
    ...
    private static class IngestionTimeWatermarkStrategy implements WatermarkStrategy<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> {
        ...
        @Override
        public WatermarkGenerator<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> createWatermarkGenerator(WatermarkGeneratorSupplier.Context context) {
            return new AscendingTimestampsWatermarks<>();
        }

        // createTimestampAssigner method
        @Override
        public TimestampAssigner<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> createTimestampAssigner(TimestampAssignerSupplier.Context context) {

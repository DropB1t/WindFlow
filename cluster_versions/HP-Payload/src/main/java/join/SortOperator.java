...
// SortOperator class
public class SortOperator extends AbstractStreamOperator<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>>
                          implements OneInputStreamOperator<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>, Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> {
	    ...
	    long minBuffered = Long.MAX_VALUE;
	   	for (Map.Entry<Integer, TsMultiset> entry: keyMinTimestamps.entrySet()) {
	        ...
	        if (kmin != null) {
	        	...
	        	Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]> wm_tuple = new Tuple7<>(entry.getKey(), 0, -1L, "", 0, 0, payload);

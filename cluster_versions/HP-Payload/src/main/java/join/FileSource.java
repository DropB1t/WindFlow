...
// FileSource class
public class FileSource extends RichParallelSourceFunction<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> {
    ...
    // run method
    @Override
    public void run(final SourceContext<Tuple7<Integer, Integer, Long, String, Integer, Integer, byte[]>> ctx) throws Exception {

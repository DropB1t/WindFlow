...
public class RawIntervalJoin extends AbstractStreamOperator<Tuple3<Integer, Integer, Long>>
                             implements OneInputStreamOperator<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>, Tuple3<Integer, Integer, Long>> {
    ...
    public void processElement(StreamRecord<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> element) {
        ...
        if (joinerId != tuple.f5) {
            throw new RuntimeException("Joiner receives a wrong tuple from the sources!");
        }
    ...
    private void processJoinOrange(BufferEntry bt) {
        final Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer> t = bt.tuple;
    ...
    // joinEmit method
    private void joinEmit(Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer> left,
                          Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer> right,
                          long leftTs,
                          long rightTs) {

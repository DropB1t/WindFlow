...
public class IntervalJoinBench {
    ...
    private static final int CALIBRATION_TIME_MS = 20000;
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (source1_deg != source2_deg) {
            LOG.error("This version needs sources with the same parallelism");
            System.exit(1);
        }
        ...
        RichParallelSourceFunction<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> orangeSource, greenSource;
        ...
        DataStream<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> orangeStream = env.addSource(orangeSource)
                                                    .setParallelism(source1_deg)
                                                    .assignTimestampsAndWatermarks(IngestionTimeWatermarkStrategy.create());

        DataStream<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> greenStream = env.addSource(greenSource)
                                                    .setParallelism(source2_deg)
                                                    .assignTimestampsAndWatermarks(IngestionTimeWatermarkStrategy.create());

        DataStream<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> unionedStream = orangeStream.union(greenStream);

        DataStream<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> forwardedStream1 = unionedStream.partitionCustom(
        ...
        SingleOutputStreamOperator<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> forwardedStream2 = forwardedStream1.process(new Forwarder(CALIBRATION_TIME_MS)).setParallelism(source1_deg + source2_deg);

        DataStream<HashMap<Integer, Integer>> calibrationStream = forwardedStream2.getSideOutput(Forwarder.controlTag);

        DataStream<HashMap<Integer, Integer>> processedControl = calibrationStream.process(new CalibrationOperator(source1_deg + source2_deg));

        MapStateDescriptor<String, HashMap<Integer,Integer>> broadcastStateDesc =
                                            new MapStateDescriptor<>("calibration-state",
                                            BasicTypeInfo.STRING_TYPE_INFO,
                                            TypeInformation.of(new TypeHint<HashMap<Integer,Integer>>() {}));

        BroadcastStream<HashMap<Integer, Integer>> broadcastStream = processedControl.broadcast(broadcastStateDesc);

        DataStream<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> routedStream = forwardedStream2
                            .connect(broadcastStream)
                            .process(new Router(join_deg, broadcastStateDesc, max_splitting_degree, threshold)).setParallelism(source1_deg + source2_deg);

        DataStream<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> multicastStream = routedStream.partitionCustom(
                new Partitioner<Integer>() {
                    @Override
                    public int partition(Integer key, int numPartitions) {
                        return key;
        ...
        TypeInformation<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> outType1 = TypeInformation.of(new TypeHint<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>>() {});

        DataStream<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> sortedStream =
    ...
    private static class IngestionTimeWatermarkStrategy implements WatermarkStrategy<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> {
        ...
        @Override
        public WatermarkGenerator<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> createWatermarkGenerator(WatermarkGeneratorSupplier.Context context) {
            return new AscendingTimestampsWatermarks<>();
        }

        // createTimestampAssigner method
        @Override
        public TimestampAssigner<Tuple7<Integer, Integer, Long, String, Integer, Integer, Integer>> createTimestampAssigner(TimestampAssignerSupplier.Context context) {
